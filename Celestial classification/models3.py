...
#xgb_clf = XGBClassifier(n_estimators = 10000, n_jobs=-1, random_state=random_seed)
...
# catboost
cat_clf = CatBoostClassifier(iterations = 1000, random_state = random_seed, task_type="GPU")
#cat_clf = CatBoostClassifier(iterations = 10000, random_state = random_seed)
...
#lgbm_clf = LGBMClassifier(n_estimators = 10000, n_jobs=-1, random_state = random_seed)
